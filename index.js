...
class Airplane {
 ...
 class Person {
   ...
   eat(food)
   {
     if(this.stamach.length < 10)
     {
       this.stamach.push(food);
     }
     else
     {
 ...
 class Instructor extends Lambdasian {
   ...
   {
     super(achildeAtributes);
     this.specialty = childeAttributes.specialty;
     this.favLanguage = childeAtributes.favLanguage;
     this.catchPhrase = childeAttributes.catchPhrase;
   }
